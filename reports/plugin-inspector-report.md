...
| ------------ | -------- | ------------ | ----------------------------------------------------------- | -------------------------------------------- | ------------------ |
| openclaw-okf | high     | dynamic-tool | agent_end, before_prompt_build, gateway_start, gateway_stop | definePluginEntry, registerCli, registerTool | tools              |
...
| ------------ | --------------------------- | ----- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| openclaw-okf | seam-inventory              | log   | observed 4 hooks, 3 registrations, and 1 manifest contracts                           | hook:agent_end, hook:before_prompt_build, hook:gateway_start, hook:gateway_stop, registration:definePluginEntry, registration:registerCli, registration:registerTool, manifestContract:tools | -             |
| openclaw-okf | package-metadata            | log   | selected package metadata for plugin contract checks                                  | package.json, openclaw-okf, version:0.1.0                                                                                                                                                    | -             |
| openclaw-okf | declarative-contracts       | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                                                                                                                                        | -             |
